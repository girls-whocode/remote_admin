...
function display_help() {
  ...
  case "$1" in
    ...
    "local_menu")
        ...
        footer "right" "${app_name} v.${app_ver}" "left" "Press 'ESC' to return to the menu"
        lm_p1="The ${light_yellow}${app_name}${default} Local Menu focuses on providing a suite of utilities aimed at diagnosing and managing the server on which the application is running. This menu serves as a one-stop solution for your local server management needs."
